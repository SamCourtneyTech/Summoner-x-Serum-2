...
std::pair<std::string, float> normalizeValue(const std::string& name, const std::string& value) {
    ...
    try {
        if (name == "Env1 Atk" || name == "Env1 Hold" || name == "Env1 Dec" || name == "Env1 Rel")
            ...
            normalizedValue = uniDetToMacro(name, value);
        else if (name == "Dist_PrePost")
            normalizedValue = distPrePostToMacro(name, value);
        else if (name == "Dist_BW")
            normalizedValue = distBwToPercentage(name, value);
        else if (name == "Cho_Rate" || name == "Phs_Rate" || name == "Flg_Rate")
            normalizedValue = phaseRateToMacro(name, value);
        else if (name == "Flg_Stereo" || name == "Phs_Stereo")
            normalizedValue = degreesToPercentage(name, value);
        else if (name == "Cho_Dly" || name == "Cho_Dly2")
            normalizedValue = choDlyToPercentage(name, value);
        else if (name == "Cho_Dep")
            normalizedValue = choDepToPercentage(name, value);
        else if (name == "Cho_Filt")
            normalizedValue = choFiltToPercentage(name, value);
        else if (name == "Dist_Freq")
            normalizedValue = distFreqToPercentage(name, value);
        else if (name == "Dly_Freq")
            normalizedValue = dlyFreqToPercentage(name, value);
        else if (name == "Phs_Frq")
            normalizedValue = phsFrqToPercentage(name, value);
        else if (name == "EQ FrqL" || name == "EQ FrqH")
            normalizedValue = EQfrqToPercentage(name, value);
        else if (name == "FX Fil Freq")
            normalizedValue = distFreqToPercentage(name, value);
            ...
            normalizedValue = CmpMBndToPercentage(name, value);
